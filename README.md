...
![LEDP10_RED.png](Additional%20files%2FLEDP10_RED.png)
...
Изображение выше наглядно показаывает положение каждого из байтов данных при последовательной загрузки всез 16-ти 
